	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-4 column">
				<ul style="list-style-type: none">
					<li style="margin-top: 20px; text-align: justify"><h4>About
							Us</h4></li>
					<li style="color: white">A food court is generally an indoor
						plaza or common area within a facility that is contiguous with the
						counters of multiple food vendors and provides a common area for
						dinner.</li>
				</ul>
			</div>
			<div class="col-sm-4 column">
			...
			<div class="col-sm-4 column">
				<div>
					<p>
						<b style="color:white"> Follow Us</b>
					</p>
				</div>
				<div>
		...
		<div class="row">
			...
			<h4 style="text-align: center; color: white">
				copyright&copy;2017 <b style="color: white">Food Court</b>
			</h4>
		</div>
	</div>
</nav>
