        ...
        <div class="container">
          <div class ="row">
           <div class="col-sm-6">
       		   ...
       		   <center><h2>${product.productName}</h2></center>
      			<img src="${images}/${product.productId}.jpg" class="img-responsive" alt="${product.productName}" >
           ...
           <div class="col-sm-6">
            <br/><br/>
            <h3>Description:</h3> ${product.productDesc}
